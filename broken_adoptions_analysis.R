...
# Call:
#   coxph(formula = Surv(year_since_adopt, reentered) ~ age_at_adopt +
#           EmotDist + SEX + race + St, data = two_cohorts_min_adoptFY_clean)
#
# n= 56998, number of events= 1961
# (3703 observations deleted due to missingness)
#
#                     coef exp(coef)  se(coef)      z             Pr(>|z|)
#   age_at_adopt  0.211109  1.235048  0.007122 29.641 < 0.0000000000000002 ***
#   EmotDist      0.332796  1.394862  0.061673  5.396 0.000000068082045609 ***
#   SEXmale      -0.015697  0.984425  0.045284 -0.347             0.728865
#   raceblack     0.410447  1.507491  0.057126  7.185 0.000000000000672575 ***
#   racelatino    0.031565  1.032068  0.069997  0.451             0.652026
#   raceother     0.040433  1.041262  0.088023  0.459             0.645985
#   StFL         -0.016022  0.984106  0.248088 -0.065             0.948507
#   StHI          2.288058  9.855784  0.266584  8.583 < 0.0000000000000002 ***
#   StIN          1.108150  3.028749  0.242962  4.561 0.000005091082902800 ***
#   StKS          2.543600 12.725404  0.230292 11.045 < 0.0000000000000002 ***
#   StKY          2.367499 10.670669  0.233466 10.141 < 0.0000000000000002 ***
#   StLA          1.991422  7.325945  0.243072  8.193 0.000000000000000255 ***
#   StMN          1.297231  3.659149  0.258397  5.020 0.000000515932202415 ***
#   StMO          2.241284  9.405405  0.230987  9.703 < 0.0000000000000002 ***
#   StMS          1.794721  6.017795  0.266198  6.742 0.000000000015615679 ***
#   StMT          2.301444  9.988592  0.276784  8.315 < 0.0000000000000002 ***
#   StNE          1.000118  2.718602  0.283348  3.530             0.000416 ***
#   StNY          0.052949  1.054376  0.257273  0.206             0.836941
#   StOR          1.854498  6.388493  0.237442  7.810 0.000000000000005704 ***
#   StTX          1.927227  6.870431  0.222328  8.668 < 0.0000000000000002 ***
#   StVT          2.344655 10.429675  0.285039  8.226 < 0.0000000000000002 ***
#   ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#
#              exp(coef) exp(-coef) lower .95 upper .95
# age_at_adopt    1.2350    0.80969    1.2179     1.252
# EmotDist        1.3949    0.71692    1.2360     1.574
# SEXmale         0.9844    1.01582    0.9008     1.076
# raceblack       1.5075    0.66335    1.3478     1.686
# racelatino      1.0321    0.96893    0.8998     1.184
# raceother       1.0413    0.96037    0.8763     1.237
# StFL            0.9841    1.01615    0.6052     1.600
# StHI            9.8558    0.10146    5.8449    16.619
# StIN            3.0287    0.33017    1.8813     4.876
# StKS           12.7254    0.07858    8.1030    19.985
# StKY           10.6707    0.09371    6.7525    16.862
# StLA            7.3259    0.13650    4.5495    11.797
# StMN            3.6591    0.27329    2.2051     6.072
# StMO            9.4054    0.10632    5.9808    14.791
# StMS            6.0178    0.16617    3.5715    10.140
# StMT            9.9886    0.10011    5.8064    17.183
# StNE            2.7186    0.36784    1.5601     4.737
# StNY            1.0544    0.94843    0.6368     1.746
# StOR            6.3885    0.15653    4.0113    10.174
# StTX            6.8704    0.14555    4.4436    10.623
# StVT           10.4297    0.09588    5.9655    18.235
#
# Concordance= 0.786  (se = 0.005 )
# Likelihood ratio test= 2184  on 21 df,   p=<0.0000000000000002
# Wald test            = 1896  on 21 df,   p=<0.0000000000000002
# Score (logrank) test = 2267  on 21 df,   p=<0.0000000000000002
